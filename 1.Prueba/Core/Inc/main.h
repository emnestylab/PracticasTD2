...
#define PA_Pin GPIO_PIN_0
#define PA_GPIO_Port GPIOD
#define PB_Pin GPIO_PIN_1
#define PB_GPIO_Port GPIOD
#define PC_Pin GPIO_PIN_2
#define PC_GPIO_Port GPIOD
#define PD_Pin GPIO_PIN_3
#define PD_GPIO_Port GPIOD
#define PE_Pin GPIO_PIN_4
#define PE_GPIO_Port GPIOD
#define PF_Pin GPIO_PIN_5
#define PF_GPIO_Port GPIOD
#define PG_Pin GPIO_PIN_6
#define PG_GPIO_Port GPIOD
#define PO_Pin GPIO_PIN_7
#define PO_GPIO_Port GPIOD
